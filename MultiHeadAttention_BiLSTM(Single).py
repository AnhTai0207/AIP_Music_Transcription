...
def train_model():
    ...
    checkpointer = ModelCheckpoint(filepath= weights_dir + "MultiHeadAttention_BiLSTM(Single).hdf5", verbose=1, save_best_only=True, save_weights_only = True)
